...
// Si5351 routines used with permission from Christoph OE1CGS
// more info on the available functions is on this website
// https://www.qrp-labs.com/synth/oe1cgs.html

// needed materials:
// Arduino Nano (UNO, MiniPro will also work)
// Si5351 breakout module by AdaFruit or Chinese clone
// 3 pushbuttons
// 0.96" OLED display 128x64, with I2C control, I used the yellow/white model

// Connections
// Si5351 : 5V and GND, SDA to A4 , SCL to A5
// LCD    : 5V and GND, SDA to A4 , SCL to A5
// buttons from D2, D7 and D12 to GND (but any other pin will work too)
...
unsigned long f = 80000000;         // the Si5351 main frequency in Hz
...
void display() {
  ...
  oled.setCursor(0, 0);
  oled.println("Freq = ");
  oled.print(f / 1000.0); oled.println(" kHz");
  oled.print("Step = ");
...
// *************************************************************************************************
// functions from OE1CWG, see website above for info on how to use these functions
